...
<table class="table table-bordered">
	...
	<tr>
		...
		<td style="padding-left:10px; padding-bottom: 10px; border-color:#000000">
			<strong><?= $nama ?></strong><p style="padding-left:10px; border-color:#000000">NIP : <?=$nip?></p><br>
		</td>
	</tr>
	<tr>
		<td style="padding-left:10px; padding-bottom: 10px; border-color:#000000">
	...
	<tr>
		<td style="padding-left:10px; padding-bottom: 10px; border-color:#000000"><br>4.</td>
		<td style="padding-left:10px; padding-bottom: 10px; border-color:#000000"><br>Maksud Perjalanan Dinas</td>
		<td style="padding-left:10px; padding-bottom: 10px; border-color:#000000"><br><?= $hal ?></td>
	</tr>
	<tr>
		...
		<td style="padding-left:10px; padding-bottom:10px; border-color:#000000"><?= $angkutan ?></td>
	</tr>
	<tr>
		<td  style="padding-left:10px; padding-bottom:10px; border-color:#000000">
			6.
...
<tr>
	<td style="padding-left:10px; padding-bottom:60px; border-color:#000000">
		Perihal :<br>
		<?= $hal ?>
	</td>
